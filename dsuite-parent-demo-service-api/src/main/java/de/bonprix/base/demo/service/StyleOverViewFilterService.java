 ...
 *
 */
@Path("/styleoverviewfilters")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public interface StyleOverViewFilterService {
    ...
    @GET
    @Path("/")
    List<StyleOverViewFilter> findAll(@BeanParam @Valid Paged pageable);
    ...
    @POST
    @Path("/filtered")
    List<StyleOverViewFilter> findByFilter(StyleOverViewFilter complexFilter);
    ...
    @GET
    @Path("/{id : \\d+}")
    StyleOverViewFilter findById(@PathParam("id") @NotNull Long id);
    ...
    @PUT
    @Path("/")
    StyleOverViewFilter saveStyleOverViewFilter(@NotNull StyleOverViewFilter styleOverViewFilter);
