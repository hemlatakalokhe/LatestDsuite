...
@SpringView(
    parentName = InterceptorViewImpl.VIEW_NAME,
    name = InterceptorChild2ViewImpl.VIEW_NAME,
    ui = { VaadinUI.class },
    isDefault = false,
    order = 30)
public class InterceptorChild2ViewImpl extends AbstractMvpView<InterceptorChild2Presenter> implements InterceptorChild2View {
    ...
    protected void initializeUI() {
        ...
        setCompositionRoot(FluentUI.vertical()
            .sizeFull()
            .add(FluentUI.label()
                .captionKey(InterceptorChild2ViewImpl.VIEW_NAME)
                .get())
