...
/**
 * A simple Grid demo with BeanItemContainer where the Grid-Header-Content will get a vertical orientation.
 *
 * @author tmeissne
 *
 */
...
public class BeanItemGridRotateHeaderContentDemo extends ShowcaseWrapper {
    ...
    private void genGrid() {
        ...
        this.grid = new BeanItemGrid<>(new BeanItemContainer<>(BigGrid.class, BigGridDummyData.genGridData(200)));
        ...
        this.grid.setColumns("id", "col1", "col2", "col3", "col4", "col5", "col6", "col7", "col8", "col9", "col10", "col11", "col12", "col13", "col14", "col15",
                             "col16", "col17", "col18", "col19", "col20", "col21", "col22", "col23", "col24", "col25", "col26", "col27", "col28", "col29",
                             "col30", "col31", "col32", "col33", "col34", "col35", "col36", "col37", "col38", "col39", "col40", "col41", "col42", "col43",
                             "col44", "col45", "col46", "col47", "col48", "col49", "col50", "col51", "col52", "col53", "col54", "col55", "col56", "col57",
                             "col58", "col59", "col60");
    ...
    /**
     * All what the programming needs to do to rotate the header-content of the grid happens in this method.
     */
    private void rotatedGrid() {

        /**
         * Call this method to rotate the header-content of the grid. The header content is rotated by 90 degrees then
         */
        this.grid.rotateHeaderContent(60, 32);

        /**
         * if needed, you can set width of certain columns. here the ID - column and the Col13 - column.
         */
