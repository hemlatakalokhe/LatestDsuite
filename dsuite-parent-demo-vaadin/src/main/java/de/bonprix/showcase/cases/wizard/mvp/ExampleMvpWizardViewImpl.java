...
@SpringViewComponent
public class ExampleMvpWizardViewImpl extends AbstractMvpWizardView<ExampleMvpWizardPresenter> implements ExampleMvpWizardView<ExampleMvpWizardPresenter> {
